  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="pages/examples/dashboard.html"><b>Admin</b>LTE</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
        <p style="color:red;text-align:center;">Logout successfully</p>
        <form id="form" action="dashboard.html" method="post">
        ...
        <br>
        <a href="<c:url value="/registerpage" />" class="text-center">Register a new membership</a>
