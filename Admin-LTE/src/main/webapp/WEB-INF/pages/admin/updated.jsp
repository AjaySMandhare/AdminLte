                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4" style="margin-top:6px;">
                        ...
                        <input name="isdefault" required id="Yes" value="<c:out value='${user.getIsdefault()}'/>" type="radio" style="margin-right:2px;" name="gender">Yes
                        <input name="isdefault" required id="No" value="<c:out value='${user.getIsdefault()}'/>" checked  type="radio" style="margin-right:2px;margin-left:10px;" name="gender">No
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <select required class="form-control" name="state" >
                          <option value="<c:out value='${user.getState()}'/>" >--Select State--</option>
