  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="<c:url value="/userspage" />" class="logo">
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="<spring:url value="/images/user2-160x160.jpg"/>" class="img-circle" alt="User Image" height="150px">
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form class="form-horizontal" action="<c:url value='/addUser'/>" method="post"> 
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4" style="margin-top:6px;">
                        ...
                        <input name="gender" required id="Male" value="Male" type="radio" style="margin-right:2px;"> Male
                        <input name="gender" required id="Female" value="Female" type="radio" style="margin-right:2px;margin-left:10px;"> Female
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4" style="margin-top:6px;">
                        ...
                        <input name="isdefault" required id="No" value="No" checked type="radio" style="margin-right:2px;margin-left:10px;">No
                      </div>
                    </div>
                  ...
                  <div class="box-footer">
                    ...
                    <a href="<c:url value="/userspage" />"><span class="btn btn-default pull-right" style="width:150px;">Cancel</span></a>                   
                  </div><!-- /.box-footer -->
                </form>
              </div><!-- /.box -->
